...
def main():
    ...
    landscape.objects.add_red_dots(count=num_red_dots)  # Using add_red_dots with count
    ...
    animation_handler = AnimationHandler(
        ...
        total_box=total_box,
        screenshot_manager=screenshot_manager  # Pass the screenshot manager to the handler
    )
